            ...
            <div className="flex flex-wrap gap-1.5">
              {streamingLinks.spotify && (
                <Button
                  size="sm"
                  variant="outline"
                  className="flex-1 min-w-0 h-8 px-2 text-xs bg-spotify/10 hover:bg-spotify/20 border-spotify/30 text-spotify hover:text-spotify"
                  onClick={(e) => {
                    e.stopPropagation();
                    window.open(streamingLinks.spotify, '_blank');
                  }}
                >
                  <svg className="h-3 w-3 mr-1 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              {streamingLinks.apple && (
                <Button
                  size="sm"
                  variant="outline"
                  className="flex-1 min-w-0 h-8 px-2 text-xs bg-foreground/5 hover:bg-foreground/10 border-foreground/20"
                  onClick={(e) => {
                    e.stopPropagation();
              ...
              {streamingLinks.amazon && (
                <Button
                  size="sm"
                  variant="outline"
                  className="flex-1 min-w-0 h-8 px-2 text-xs bg-amazon/10 hover:bg-amazon/20 border-amazon/30 text-amazon hover:text-amazon"
                  onClick={(e) => {
                    e.stopPropagation();
